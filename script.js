...
function calcular() {
    ...
    // Verificando se a data de pagamento é posterior à data de início
    ...
    let taxaJurosDiaria = 0.01; // 1% ao dia de juros
    let multaDiaria = 0.01; // 1% ao dia de multa

    // Calculando o valor dos juros e da multa
    let juros = valor * taxaJurosDiaria * diffDays; // Juros de 1% ao dia
    ...
    let resultado = `Valor original: R$ ${valor.toFixed(2)}<br>
                     Juros (1% ao dia): R$ ${juros.toFixed(2)}<br>
